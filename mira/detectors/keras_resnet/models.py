...
from . import blocks as keras_resnet_blocks
from . import layers as keras_resnet_layers
...
class ResNet2D(keras.Model):
    ...
    :param block: a residual block (e.g. an instance of `keras_resnet_blocks.basic_2d`)
    ...
    Usage:
        ...
        >>> block = keras_resnet_blocks.basic_2d
    ...
    def __init__(
        ...
        **kwargs
        ...
        x = keras_resnet_layers.BatchNormalization(axis=axis, epsilon=1e-5, freeze=freeze_bn, name="bn_conv1")(x)
...
class ResNet2D50(ResNet2D):
    ...
    def __init__(self, inputs, blocks=None, include_top=True, classes=1000, freeze_bn=False, *args, **kwargs):
        ...
        super(ResNet2D50, self).__init__(
            ...
            block=keras_resnet_blocks.bottleneck_2d,
            include_top=include_top,
            classes=classes,
            freeze_bn=freeze_bn,
            *args,
